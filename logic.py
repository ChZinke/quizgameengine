...
class Item:
    def __init__(self):
        self.possible_effects = ['scoreX2', 'scoreX5', 'score/2', 'shuffle_question', 'jackpot', 'bomb', 'move_answers', 'hide_scoreboard']  # further possibilites: jackpot next question, freeze other players,
        self.debug = ['hide_scoreboard']
